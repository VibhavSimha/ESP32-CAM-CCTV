...
// the portal target is known. It also serves the device root ("/"), redirecting
// the browser to /portal once while a captive portal is pending and to /view
// afterwards, so opening the local link lands on the login step automatically.
